...
#include "DataMatrix_ZXing/DMEncoderContext.h"
...
/*
* Converts the message to a byte array using the default encoding (cp437) as defined by thespecification
* msg:  the message
...
// msg: the message, startpos: the start position within the message
...
namespace C40Encoder {
    ...
    //↓ context: the encoder context, buffer: the buffer with the remaining encoded characters
    static void HandleEOD(EncoderContext& context, std::string& buffer) //← Handle "end of data" situations
	{
