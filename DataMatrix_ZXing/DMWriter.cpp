...
#include "DataMatrix_ZXing/DMECEncoder.h"
#include "DataMatrix_ZXing/DMHighLevelEncoder.h"
#include "DataMatrix_ZXing/DMSymbolInfo.h"
...
// placement : The DataMatrix placement. symbolInfo: The symbol info to encode.
...
BitMatrix Writer::encode(const std::wstring& contents, int width, int height) const
{
    ...
    auto encoded = ZXing::DataMatrix::Encode(contents, _shapeHint, _minWidth, _minHeight, _maxWidth, _maxHeight);
    const ZXing::DataMatrix::SymbolInfo* symbolInfo = ZXing::DataMatrix::SymbolInfo::Lookup(Size(encoded), _shapeHint, _minWidth, _minHeight, _maxWidth, _maxHeight);
    ...
    ZXing::DataMatrix::EncodeECC200(encoded, *symbolInfo);

    //↓ 3. step: Module placement in Matrix
    BitMatrix symbolData = ZXing::DataMatrix::BitMatrixFromCodewords(encoded, symbolInfo->symbolDataWidth(), symbolInfo->symbolDataHeight());
