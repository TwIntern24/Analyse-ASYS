...
{	
    return ToInt(eci) <= 899;   // see https://github.com/zxing-cpp/zxing-cpp/commit/d8587545434d533c4e568181e1c12ef04a8e42d9#r74864359
}

std::string ToString(ECI eci);  //← converts the numerical ECI value to a 7 character string as used in the ECI protocol; return e.g. "\000020".
